...
module.exports = function (options) {
    ...
    if (!userWebpackConfig.override) { // 混合配置
        ...
        //     // 自己没有配置就优先使用同步common
        //     let hasCommonPlugins = false;
        //     webpackConfig.plugins.every(function (value) {
        //         if (value instanceof webpack.optimize.CommonsChunkPlugin) {
        //             hasCommonPlugins = true;
        //             return false;
        //         } else {
        //             return true;
        //         }
        //     });
        //     hasCommonPlugins || webpackConfig.plugins.push(new webpack.optimize.CommonsChunkPlugin({
        //         name: 'common',
        //         filename: path.join(webpackConfig.output.jsDir, (
        //             options.hash ?
        //             'common-[chunkhash:8].js' :
        //             'common.js'
        //         )),
        //         minChunks: 2
        //     }));
